...
puts "Est-ce que c'est vrai que 3 + 2 < 5 - 7 ?" #Est-ce que c'est vrai que 3 + 2 < 5 - 7 ?
...
puts "Ok, c'est faux alors !" #Ok, c'est faux alors !

puts "C'est drôle ça, faisons-en plus :" #C'est drôle ça, faisons-en plus :

puts "Est-ce que 5 est plus grand que -2 ? #{5 > -2}" #Est-ce que 5 est plus grand que -2 ? ture
...
# #{} permet de mettre du code Ruby dans une chaîne.